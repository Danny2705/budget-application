        ...
        <div className="mt-8 text-white">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <section className="mt-8 flex flex-col">
              ...
              <p className="text-base md:text-lg leading-relaxed flex-grow">
              ...
              <p className="mt-4 text-base md:text-lg leading-relaxed flex-grow">
            ...
            <section className="mt-8 lg:mt-0 flex flex-col">
              <h2 className="large-h1-span text-2xl md:text-3xl font-bold tracking-wide">
                Our Vision
              </h2>
              <p className="text-base md:text-lg leading-relaxed flex-grow">
