...
// Template Component using from landingfolio.com library
        ...
        <div className='grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12'>
          <div className='col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8'>
            ...
            <p className='text-base leading-relaxed text-white mt-7'>
              ...
              Track expenses, set goals, and manage your savings all in one
              place.
            </p>
            ...
            <form className='mt-6'>
              <div>
                ...
                <input
                  ...
                  className='block w-full p-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-main-neonPink caret-main-neonPink'
                />
              </div>
